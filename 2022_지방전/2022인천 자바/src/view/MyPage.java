...
public class MyPage extends BasePage {
	...
	String cap = "백신내역", str_arr[] = new String[100];
	LocalDate date_arr[] = new LocalDate[100];
	...
	void ui() {
...

		{
			...
			cn.add(img, "West");
			cn.add(sz(lbl("<html><pre><font face='맑은 고딕'>이름\t" + uname + "<br>비밀번호\t" + pw + "<br>전화번호\t" + uphone
					+ "<br>거주지\t"
					+ getOne("select b.name from building b, user u where b.point = u.point and u.no = '" + uno + "'")
					+ "</font></pre>", JLabel.LEFT, 20), 250, 300));
